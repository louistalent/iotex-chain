...
contract FLASH is Context, IBEP20, Ownable {
    ...
    function excludeFromTxLimit(address account, bool _value)
        external
        onlyOwner
    {
    ...
    function setAllBuyFeePercentages(
    ...
    function setAllSaleFeePercentages(
        uint256 liquidityFee,
        uint256 marketingFee,
        uint256 stakeFee
    ) external onlyOwner {
    ...
    function setNumTokensSellToAddToLiquidity(uint256 __minimumTokensBeforeSwap)
        external
        onlyOwner
    {
    ...
    function updatePackages(
        uint256 _rewardFor90Days,
        uint256 _rewardFor180Days,
        uint256 _rewardFor360Days
    ) external onlyOwner {
    ...
    function setStakingAndUnstakingFees(
        uint256 stakingFee,
